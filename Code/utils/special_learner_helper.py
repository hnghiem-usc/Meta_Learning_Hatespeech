...
def meta_quick_eval(model, meta_loader, num_epochs=1, batch_size=10, lr_dict:dict={},
    ...
    for epoch in range(num_epochs): 
        train_losses, train_acc, train_f1, _= model.train_fast_model(fast_model, fast_optimizer, train_loader, None, task_config, 
                                  ...
                                  scheduler = fast_scheduler, wd_clf=model.wd_clf
                                  )

        train_loss_mean = get_average_report(train_losses, num_round=4)[0]
